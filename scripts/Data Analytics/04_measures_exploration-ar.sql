...
SELECT COUNT(order_number) AS total_orders FROM gold.fact_sales --has duplicate order numbers
...
SELECT COUNT(DISTINCT customer_key) AS ordering_customers FROM gold.fact_sales
